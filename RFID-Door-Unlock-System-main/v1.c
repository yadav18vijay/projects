// RFID Based door lock system Using 8051 Microcontroller
...
void main()
{
    ...
    while(1)
    {
        ...
        lcddata(rfid[i]);
        delay(100);
        if(strncmp(rfid,"1600ADC369A",12)==0)
        {
            counter1++;
            lcdcmd(1);             
        ...
        else if(strncmp(rfid,"1600ADC368A2",12)==0)
            {
            counter2++;
            lcdcmd(1);
            lcdstring(" Authorised");
            ...
            Motor2=0;
                ...
                else if(strncmp(rfid,"1600ABCD14A3",12)==0)
            {
                counter3++;
            lcdcmd(1);
            lcdstring(" Authorised");
